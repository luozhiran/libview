...
import com.sup.itg.crop.anim.ValueAnimatorV8;
...
import com.sup.itg.crop.util.HandleUtil;
import com.sup.itg.crop.util.PaintUtil;
import com.sup.itg.crop.anim.SimpleValueAnimator;
...
public class CropImageView extends ImageView {
    ...
    public void rotateImage(int degrees, int durationMillis) {
        if (mIsRotating) {
            getAnimator().cancelAnimation();
        }

        final float currentAngle = mAngle;
        final float newAngle = (mAngle + degrees);
